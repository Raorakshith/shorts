...
import { View, Text, Dimensions, TouchableOpacity, Image, SafeAreaView ,ToastAndroid} from 'react-native';
...
const SingleReel = ({ item, index, currentIndex,props}) => { 
    ...
    return (
        <View
            ...
            />
            <View
                style={styling.SingleReelView1}>
                <View style={{}}>
                    <TouchableOpacity style={{ width: 150 }}>
                        <View
                            style={styling.SingleReelView2}>
                            <View
                                style={styling.SingleReelView3}>
                                <Image
                    ...
                    <Text style={styling.Description}>
                        {item.description}
                    </Text>
            ...
            <View
                ...
                <View
                    style={styling.ImageView}>
                    <Image
                        source={item.postProfile}
                        style={styling.ProfileView}
                    />
                </View>
            </View>
